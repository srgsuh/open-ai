...
SYSTEM_CONTENT = f"""
If the user’s request contains the phrase "from '<country_from_name>' to '<where_to_name>'",
and '<where_to_name>' is a real country name or a city_name
...
{{
   ...
   "{country_to}": "<Name of the destination country>",
